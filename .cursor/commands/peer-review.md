...
Have different models review each other's work. Have Codex or Gemini review code that Claude wrote, then bring that feedback back. The dev lead verifies each finding rather than accepting blindly.
